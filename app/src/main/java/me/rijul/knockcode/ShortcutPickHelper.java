...
import me.rijul.knockcode.ShortcutPickHelper.AppExpandableAdapter.GroupInfo;
...
public class ShortcutPickHelper {
    ...
    private void processShortcut(final Intent intent, int requestCodeApplication, int requestCodeShortcut) {
        ...
        String applicationName = mParent.getString(R.string.shortcut_helper_apps);
        String application2name = mParent.getString(R.string.shortcut_helper_activities);
